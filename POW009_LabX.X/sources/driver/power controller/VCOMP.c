...
volatile int16_t VCOMP_pterm_factor = 0x48DF;     // Q15 fractional of the P-Term factor
volatile int16_t VCOMP_pterm_scaler = 0xFFFE;     // Bit-shift scaler of the P-Term factor
